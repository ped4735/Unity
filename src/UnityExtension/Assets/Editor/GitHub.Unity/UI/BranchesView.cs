...
namespace GitHub.Unity
{
    ...
    class BranchesView : Subview
    {
        ...
        {
            var localBranches = Repository.LocalBranches.ToList();
            localBranches.Sort(CompareBranches);
            var remoteBranches = Repository.RemoteBranches.ToList();
